...
// Readfile
    fstream file; file.open("data.txt"); string line;

    while(getline(file, line, '\n')){
        istringstream templine(line); string data;
...
// Readfile
    fstream file; file.open("key_query.txt"); string line;
...
// Readfile
    fstream file; file.open("range_query.txt"); string line;

    while(getline(file, line, '\n')){
        istringstream templine(line); string data1, data2;
        getline(templine, data1,','); getline(templine, data2,',');
